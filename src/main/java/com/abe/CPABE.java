...
public class CPABE {
    ...
    public static void kemEncrypt(String data, String policyName,
                               String pkFileName, String ctFileName) throws GeneralSecurityException, IOException, JSONException {
...
//        进行共享，使得每个叶子节点获得相应的秘密分片
    ...
    public static String kemDecrypt(String ctFileName, String skFileName) throws GeneralSecurityException, IOException, JSONException {
...
//            System.out.println(fileName + " load failed!");
    ...
    // 将字符串形式的访问树转换为映射结构
    public static Map<String, TreeNode> jsonStringToAccessTree(String accessTreeString) throws JSONException {
    ...
    public static void jsonToTree(JSONObject obj, Map<String, TreeNode> map) throws JSONException {
